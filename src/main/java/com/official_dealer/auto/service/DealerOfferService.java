...
import com.official_dealer.auto.repository.DealerOfferRepository;
...
public class DealerOfferService {
    ...
    public DealerOffer createOffer(Dealer dealer, Model model,
                                   Integer releaseYear, Trim trim, String generationName,
                                   Integer stockQuantity, BigDecimal price) {
        DealerOffer offer = new DealerOffer(dealer, model, trim, releaseYear, generationName, stockQuantity, price);
